                ...
                <form class="mt-8 space-y-6">
                    ...
                    <div class="rounded-md shadow-sm -space-y-px">
                        <div>
                            ...
                            <input id="username" v-model="username" type="text" autocomplete="username" required="true"
                    ...
                    <div class="flex items-center">
                        <p>
                            ...
                            <span class="cursor-pointer	" @click="$emit('switchScreen', 'the-register')">Register here.</span>
                        </p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember-me" v-model="remember" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
...
export default {
    data() {
        ...
        submitLogin() {
            console.log('username', this.username, 'password', this.password, 'check', this.remember)
            ...
            axios
                ...
                .then(res => {
                    if (res.data.success) {
                        ...
                        // );
                        console.log('here before router')
