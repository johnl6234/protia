            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <form class="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div class="rounded-md shadow-sm -space-y-px">
                        <div>
                            <label for="name" class="sr-only">First And Last</label>
                            <input id="name" v-model="name" type="text" autocomplete="name" required="true"
                        ...
                        <div>
                            ...
                            <input id="email-address" v-model="email" type="email" autocomplete="email" required="true"
                                class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm mb-3"
                                placeholder="Email address" />
                        </div>
                        <div>
                            <label for="password" class="sr-only">Password</label>
                            <input id="password" v-model="password" type="password" autocomplete="current-password" required="true"
                        ...
                        <div>
                            ...
                            <input id="password-confirm" v-model="passwordConfirm" type="password" autocomplete="current-password" required="true"
                    ...
                    <div class="flex items-center">
                        <p>
                            ...
                            <span class="cursor-pointer	" @click="$emit('switchScreen', 'the-login')">Login here.</span>
                        </p>
                    </div>
...
export default {
    data() {
        ...
        submitRegister() {
            ...
            console.log('email', this.email, 'password', this.password, 'check', this.remember)
            if (
                this.name === '' ||
                this.email === '' ||
                this.password === '' ||
